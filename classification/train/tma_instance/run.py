...
do_plot_misclassifications = True  # True
do_plot_correctly_classified = True
    ...
    for net_name in net_names:
        for target, label_mapping, classes_encoding, class_name, train_config, val_config in zip(
            ...
            for fold in range(folds):
                ...
                net_path = os.path.join(net_fold, f'{net_name}_{target}_{train_version}.pth')
                metrics_pkl = os.path.join(net_fold, f'metrics_trends_{net_name}_{target}_{train_version}.pkl')
                ...
                if os.path.exists(net_path):
                    ...
                    print(f"Saving Model to {net_path}")
                ...
                plot_curves(all_curves_roc, title=f"ROC {net_name} ({comp_name})", save_path=roc_curves_path,
                            ...
                            percent_multiplier=percent_multiplier, ndigits=ndigits)
