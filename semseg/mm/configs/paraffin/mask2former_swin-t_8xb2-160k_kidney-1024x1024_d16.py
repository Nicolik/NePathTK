...
test_dataloader = dict(
    ...
    dataset=dict(
        data_prefix=dict(
            img_path='Test/Downsample-16/Image',
            seg_map_path='Test/Downsample-16/Mask'),
        data_root='E:/AnnotationsCortexMedulla/v6',
        pipeline=[
...
train_dataloader = dict(
    ...
    dataset=dict(
        data_prefix=dict(
            img_path='Train/Downsample-16/Image',
            seg_map_path='Train/Downsample-16/Mask'),
        data_root='E:/AnnotationsCortexMedulla/v6',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(reduce_zero_label=False, type='LoadAnnotations'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        data_prefix=dict(
            img_path='Validation/Downsample-16/Image',
            seg_map_path='Validation/Downsample-16/Mask'),
        data_root='E:/AnnotationsCortexMedulla/v6',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(reduce_zero_label=False, type='LoadAnnotations'),
...
work_dir = './work_dirs\\mask2former_swin-t_8xb2-160k_kidney-1024x1024_d16'
