...
from semseg.mm.util import get_glomerulus_artery_arteriole_mmsegmenter, run_segmentation_mm
...
if __name__ == '__main__':
    ...
    mm_model = get_glomerulus_artery_arteriole_mmsegmenter(arch=args.arch, enc_name=args.enc_name, device=device,
