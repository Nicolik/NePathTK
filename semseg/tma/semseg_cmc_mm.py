...
from semseg.mm.util import get_cortex_medulla_capsule_mmsegmenter, run_segmentation_mm
...
if __name__ == '__main__':
    ...
    mm_model = get_cortex_medulla_capsule_mmsegmenter(arch=args.arch, enc_name=args.enc_name, device=device,
                                                      use_tta=args.use_tta, microscopy_type=args.microscopy_type)
    class_names = ["Background", "Cortex", "Medulla", "CapsuleOther"]
