...
import ttach as tta
from semseg.tma.util import get_cortex_medulla_capsule_segmenter
...
if __name__ == '__main__':
    ...
    pl_model = get_cortex_medulla_capsule_segmenter(arch=args.arch, enc_name=args.enc_name, device=device)
